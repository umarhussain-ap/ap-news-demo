...
public class SportsController {
    ...
    public ResponseEntity<List<SportsDto>> getSportWithMultiplePlayers(@Valid @PathVariable(name = "playerCount")
                                                                           Integer playerCount) {
    ...
    public ResponseEntity<List<SportsDto>> getSportsByNames(
            @Valid @NotEmpty(message = "sportNames list cannot be empty")
            @RequestParam("sportNames") Set<String> sportNames) {
...
//crud
     ...
     */
    @GetMapping("/{Id}")
    public ResponseEntity<SportsDto> getSport(@NotNull(message = "Id cannot be null")
